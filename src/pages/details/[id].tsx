...
export default function Details() {
  ...
  return (
    <div className=" dark:text-white text-black lg:px-24 min-h-screen">
      {loading ? (
        <div className="flex justify-center items-center min-h-screen">
          <Circles color="#6b21a8" height={80} width={80} />
        </div>
      ) : (
        <div className="flex flex-col lg:flex-row  lg:rounded-lg bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10">
